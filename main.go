...
const (
	...
	Timeout     = 800 * time.Millisecond // Таймаут на один запрос
	Concurrency = 20000                   // Количество параллельных потоков
	StatusStep  = 40000                  // Частота обновления статуса в консоли
)
...
func main() {
	...
	targetPorts := []int{25567, 25569, 25570, 25571, 25582, 25583, 25584, 25587, 25599, 25600, 25888}
